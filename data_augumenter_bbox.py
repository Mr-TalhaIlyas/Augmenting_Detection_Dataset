...
classes = [ "blossom_end_rot", "graymold","powdery_mildew","spider_mite","spotting_disease", "crown"]
...
#%%
img_path = glob.glob(os.path.join('D:/cw_projects/bb_aug/*.jpg'))
xml_path = glob.glob(os.path.join('D:/cw_projects/bb_aug/*.xml'))

op_img_path = 'D:/cw_projects/aug_data/'
op_xml_path = 'D:/cw_projects/aug_data/'

print('='*60)
print('WARNING: The "imgaug" library is quite slow in augumenting \nthe detection dataset. \nIt takes about 9 Seconds per image')
print('='*60)
